...
<section style="margin-top: 25px">
  <div class="container">
    <div class="jumbotron">
      <h2 style="font-family: GenghisKhan;font-size: 35px;color:#113c69;text-align:center"><b>{{ __('vacancy.vacancy2') }}</b></h2>
  ...
  <section style="margin: 20px 0px;padding: 20px 40px;">
	<div class="container">
      @foreach($departments as $department)
          @if($department->id==4)
              <h2 style="font-family: GenghisKhan;font-size: 35px;color:#113c69;text-align:center"><b><i class="fas fa-desktop" style="margin:0px 10px"></i>{{$department->dept_name}}</b></h2>
          @endif
      @endforeach
    </div>
    <div class ="container">
      <div class="row" style="justify-content:center;">
      @foreach($career_job as $career_jobs)
          @if($career_jobs->dept_id==4)
            <div class="card" style="margin:10px 5px;border:0;width: 275px;">
              <div class="card" style="height:110px">
                <div>
                  <h5 style="font-family: GenghisKhan;color:#113c69;margin:10px 20px;text-align: center;"><b>{{$career_jobs->job_title}}</b></h5>
                </div>
                <div style="display: flex; justify-content: center;margin:0px 10px">
                  <p><b><i class="fas fa-shopping-bag" style="margin:0px 10px"></i>{{$career_jobs->career_category->category_name}}</b></p>
                  @if($career_jobs->country->country_code=="IN")
                    <p><b><i class="fas fa-map-marker-alt" style="margin:0px 10px"></i>India</b></p>
                  @endif
                  @if($career_jobs->country->country_code=="ID")
                    <p><b><i class="fas fa-map-marker-alt" style="margin:0px 10px"></i>Indonesia</b></p>
                  @endif
                  @if($career_jobs->country->country_code=="SG")
                    <p><b><i class="fas fa-map-marker-alt" style="margin:0px 10px"></i>Singapore</b></p>
                  @endif
                  @if($career_jobs->country->country_code=="AE")
                    <p><b><i class="fas fa-map-marker-alt" style="margin:0px 10px"></i>Uni Emirat</b></p>
                  @endif
                  @if($career_jobs->country->country_code=="VN")
                    <p><b><i class="fas fa-map-marker-alt" style="margin:0px 10px"></i>Vietnam</b></p>
                  @endif
                </div>
              </div>
              <div class="card">
                <div style="margin: 4% 20%;">
                  <a href="/form/{{$career_jobs->id}}" class="btn btn-apply-now">{{ __('vacancy.apply-now') }}</a>
                </div>
                <div style="margin: 4% 20%;">
                  <a href="/detailjob/{{$career_jobs->id}}" class="btn btn-see-details">{{ __('vacancy.see-details') }}</a>
                </div>
              </div>
            </div>
          @endif
        ...
        <div class="col-sm-12 col-md-7 col-lg-7 col-xl-7" style="margin:10px 0px 0px 0px">
          <div class="row">
            <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3" style="margin:5px 0px">
              <a href="/"><h5 style="font-family: GenghisKhan;font-weight: 600;color:#113c69;float:right">{{ __('vacancy.home2') }}</h5></a>
            </div>
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4" style="margin:5px 0px">
              <a href="/about-us"><h5 style="font-family: GenghisKhan;font-weight: 600;color:#113c69;float:right">{{ __('vacancy.about-us2') }}</h5></a>
            </div>
            <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3" style="margin:5px 0px">
              <a href="/vacancy"><h5 style="font-family: GenghisKhan;font-weight: 600;color:#113c69;float:right">{{ __('vacancy.vacancy2') }}</h5></a>
            </div>
            <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2" style="margin:5px 0px">
              <a href="/faq"><h5 style="font-family: GenghisKhan;font-weight: 600;color:#113c69;float:right">{{ __('vacancy.faq2') }}</h5></a>
            </div>
          </div>
