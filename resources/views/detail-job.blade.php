...
<body>
    ...
    <section style="margin: 0px 0px;padding: 20px 40px;">
        <div class="container">
            @foreach ($detailjob as $detail)
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <span>
                            Location: {{ $detail->name_location }}
                        </span>
                    </div>
                    <div class="col-md-4" style="display: flex; justify-content: right;">
                        <a
                            href="https://docs.google.com/forms/d/e/1FAIpQLSefSl2VEdBukQSxDpjHMkgj4kiY1bIC37b6pRBs7Wy8Ynjl3g/viewform?usp=pp_url">
                            <div
                                style="color: #fff; background-color: #123e62; border-radius: 20px; width: 100px; height: 50px; padding: 12px 10px; text-align: center;">
                                Apply Now</div>
                        </a>
                    </div>
                </div>
