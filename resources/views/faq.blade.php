...
<section style="margin-top: 25px">
  <div class="container">
    <div class="jumbotron">
      <h2 style="font-family: GenghisKhan;font-size: 35px;color:#113c69;text-align:center"><b>FAQ</b></h2>
...
<section style="padding:0">
  <div class="container">
    @foreach($faq as $faqs)
      <button class="accordion">{{ $faqs->faq_question }}</button>
    <div class="panel">
      {!!html_entity_decode($faqs->faq_answer)!!}
    </div>
    @endforeach
  </div>
</section>
